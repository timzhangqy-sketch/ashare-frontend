...
function normalizeMain(
  ...
  return {
    ...
    open: detail?.open ?? quote?.open ?? null,
    high: detail?.high ?? quote?.high ?? null,
    low: detail?.low ?? quote?.low ?? null,
    ma5: detail?.ma5 ?? quote?.ma5 ?? null,
    ma10: detail?.ma10 ?? quote?.ma10 ?? null,
    ma20: detail?.ma20 ?? quote?.ma20 ?? null,
    vr: detail?.vr ?? quote?.vr ?? null,
    peTtm: detail?.pe_ttm ?? quote?.pe_ttm ?? null,
    pb: detail?.pb ?? quote?.pb ?? null,
    totalMvYi: detail?.market_cap_yi ?? quote?.total_mv_yi ?? null,
    primaryConcept: (detail as any)?.primary_concept ?? null,
    isLeader: Boolean((detail as any)?.is_leader),
    pctChg5d: (detail as any)?.pct_chg_5d ?? quote?.pct_chg_5d ?? null,
    pctChg10d: (detail as any)?.pct_chg_10d ?? quote?.pct_chg_10d ?? null,
    pctChg20d: (detail as any)?.pct_chg_20d ?? quote?.pct_chg_20d ?? null,
    high60d: (detail as any)?.high_60d ?? quote?.high_60d ?? null,
    low60d: (detail as any)?.low_60d ?? quote?.low_60d ?? null,
    closeVsMa20Pct: (detail as any)?.close_vs_ma20_pct ?? quote?.close_vs_ma20_pct ?? null,
  }
}
